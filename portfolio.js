      ...
      (function lightboxSetup() {
        ...
        qsa('.port-item').forEach(function(item) {
          item.addEventListener('click', function() {
            var src = item.getAttribute('data-src') || (qs('img', item) && qs('img', item).src);
      ...
      (function demoReel() {
        ...
        var driveLink = 'https://drive.google.com/drive/folders/1ITEOPtcNFw0t-H8Gj1xjpqNvFcKxak52?dmr=1&ec=wgc-drive-hero-goto';
        if (!demoBtn) return;
